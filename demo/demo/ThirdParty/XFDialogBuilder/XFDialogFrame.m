...
+ (instancetype)dialogWithCustomView:(UIView*)customView maskView:(XFMaskView *)maskView attrs:(NSDictionary *)attrs commitCallBack:(CommitClickBlock)commitCallBack
{
    // 初始化对话框
    XFDialogFrame *dialogFrameView = [[self alloc] init];
    dialogFrameView.attrs = [attrs mutableCopy];
    ...
    dialogFrameView.customView = customView;
