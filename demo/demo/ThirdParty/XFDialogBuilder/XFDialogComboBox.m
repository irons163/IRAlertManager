...
- (CGSize)dialogSize
{
    CGFloat height = [self realTitleHeight] + [self realCommandButtonHeight] + [self.attrs[XFDialogComboBoxList] count] * XFDialogRealValueWithFloatType(XFDialogComboBoxH, XFDialogComboBoxDefH) + ([self.attrs[XFDialogComboBoxList] count] + 1) * XFDialogRealValueWithFloatType(XFDialogComboBoxMargin, XFDialogComboBoxDefMargin);
    if(self.customView){
